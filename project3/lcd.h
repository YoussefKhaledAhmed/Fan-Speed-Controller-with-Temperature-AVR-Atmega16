...
/* LCD RS PIN */
#define LCD_RS_PORT_ID 		PORTD_ID /* THE PORT WHERE RS PIN IS CONNECTED */
#define LCD_RS_PIN_ID 		PIN0_ID /* RS PIN logic_low for transferring instructions , logic_high for data */

/* LCD R/(W)' PIN */
#define LCD_RW_PORT_ID 		PORTD_ID /* THE PORT WHERE R/W PIN IS CONNECTED */
#define LCD_RW_PIN_ID 		PIN1_ID /* R/(W)' logic_low for write , logic_high for read */

/* LCD ENABLE PIN */
#define LCD_ENABLE_PORT_ID 	PORTD_ID /* THE PORT WHERE THE ENABLE PIN IS CONNECTED */
